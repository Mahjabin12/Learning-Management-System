...
function StudentSidebar({ isOpen = false, onClose, theme = "dark" }) {
  ...
  const links = [
    ...
    { name: "My Learning", path: "/student/my-learning", icon: "▣" },
    { name: "Cart", path: "/student/cart", icon: "◈" },
    ...
    >
      ...
      >
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className={`text-2xl font-black ${isDark ? "text-white" : "text-[#061311]"}`}>
              Skillora
            </h1>
